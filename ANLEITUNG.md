...
Öffne die Download-Seite und klicke auf die Datei, die mit **`rikus-zram_`** anfängt und auf **`.deb`** endet (z. B. `rikus-zram_1.23_all.deb` — die Zahl ist die Fassung):
...
```
cd ~/Downloads
sudo apt install ./rikus-zram_1.23_all.deb
```
